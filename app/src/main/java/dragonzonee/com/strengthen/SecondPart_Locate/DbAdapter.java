...
public class DbAdapter {
	...
	private final static String DATABASE_PATH = /*"/data/data/dragonzonee.com.store/databases";*/ android.os.Environment
	...
	public DbAdapter open() throws SQLException {
		System.out.println("就要调用getwritableDataBase方法了！！");
		db = dbHelper.getWritableDatabase();
		System.out.println("调用getwritableDataBase方法");
		return this;
	}
